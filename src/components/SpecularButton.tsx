...
export const SpecularButton = ({
  ...
  useEffect(() => {
    ...
    let cancelRef: number | null = null;
    ...
    try {
      ...
      const program = new Program(gl, {
        ...
        uniforms: {
          ...
          uBaseColor: { value: [0.81, 0.51, 0.15] },
      ...
      const update = (now: number) => {
        cancelRef = requestAnimationFrame(update);
        ...
        // Touch devices get subtle ambient highlight; desktop reacts to cursor proximity
        const brightTarget = p.autoAnimate ? 1 : isTouch ? 0.75 : proximityT;
      ...
      return () => {
        if (cancelRef !== null) cancelAnimationFrame(cancelRef);
        if (ro) ro.disconnect();
